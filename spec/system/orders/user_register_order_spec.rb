...
describe 'usuário registra ordem de serviço' do
  ...
  it 'e vê página de cadastro' do
    ...
    expect(page).to have_field 'Distância de Entrega (Km)'
  ...
  it 'com dados em branco' do
    ...
    fill_in 'Distância de Entrega (Km)', with: ''
    ...
    expect(page).to have_content 'Distância de Entrega (Km) não pode ficar em branco'
    ...
    expect(page).to have_content 'Distância de Entrega (Km) não é um número'
  end
  ...
  it 'com dimensões inválidas' do
    ...
    fill_in 'Distância de Entrega (Km)', with: 'AB'
    fill_in 'Código do Produto', with: 'X356-8PQ'
    ...
    expect(page).to have_content 'Peso da Carga deve ser maior ou igual a 0'
    expect(page).to have_content 'Largura da Carga deve ser maior ou igual a 0'
    expect(page).to have_content 'Altura da Carga não é um número'
    expect(page).to have_content 'Distância de Entrega (Km) não é um número'
  end
